              ...
              >
                ...
                <div className="mt-6 p-4 rounded-lg border bg-gray-50">
                  <p className="text-lg font-semibold">
                    Total Estimated Manpower Cost:
                    <span className="text-blue-700 ml-2">
                      ₹ {calculateTotalManpowerCost().toLocaleString()}
                    </span>
                  </p>

                  <p className="mt-2">
                    Available Manpower Budget:
                    <span className="font-semibold ml-2">
                      ₹ {selectedHeadAmount?.toLocaleString()}
                    </span>
                  </p>

                  {isBudgetExceeded ? (
                    <p className="text-red-600 font-semibold mt-2">
                      ⚠ Requested manpower cost exceeds available budget
                    </p>
                  ) : (
